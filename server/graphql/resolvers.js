...
const resolvers = {
	Query: {
		projects: (parent, args) => projects.getProjects(args.absolute_year, args.org_id, args.mentor_id, args.applicant_id),
		project: (parent, args) => { return { "project_id": args.project_id }; },
		organizations: (parent, args) => organizations.getOrganizations(args.absolute_year),
		organization: (parent, args) => { return { "org_id": args.org_id }; },
		applications: (parent, args) => applications.getApplications(args.absolute_year, args.project_id, args.org_id, args.applicant_id),
		mentors: (parent, args) => mentors.getMentors(args.absolute_year, args.org_id),
		...
		superAdmins: (parent, args) => superAdmins.getSuperAdmins(args.absolute_year),
	...
	Mutation: {
		...
		addProject: (parent, args) => projects.addProject(args.name, args.work, args.deliverables, args.prerequisites, args.absolute_year, args.project_start_date, args.project_end_date, args.org_id, args.mentor_ids),
		deleteProject: (parent, args) => projects.deleteProject(args.project_id),
		updateProject: (parent, args) => { projects.updateProject(args.project_id, args.name, args.work, args.deliverables, args.project_start_date, args.project_end_date); },
		...
		addOrgAdmin: (parent, args) => orgAdmins.addOrgAdmin(args.email, args.password, args.name, args.org_id, args.absolute_year),
		deleteOrgAdmin: (parent, args) => orgAdmins.deleteOrgAdmin(args.org_admin_id),
		addMentorToOrg: (parent, args) => mentors.addMentorToOrg(args.mentor_id, args.org_id),
		removeMentorFromOrg: (parent, args) => mentors.removeMentorFromOrg(args.mentor_id, args.org_id),
		addMentorToProject: (parent, args) => mentors.addMentorToProject(args.mentor_id, args.project_id),
		removeMentorFromProject: (parent, args) => mentors.removeMentorFromProject(args.mentor_id, args.project_id),
		addPrerequisites: (parent, args) => projects.addPrerequisites(args.project_id, args.prerequisites),
		removePrerequisites: (parent, args) => projects.removePrerequisites(args.project_id, args.prerequisites),
	},
