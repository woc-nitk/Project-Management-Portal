...
export default function About() {
  return (
    <section className="container" style={{
      ...
      <iframe width="100%" height="100%" src="https://docs.google.com/document/d/e/2PACX-1vThSzPc9LQZ0gHLLqy1g9JIMRK9qke9EvheKTtnzhuuBkfO6vaWNH3QnXBQpiX84CtkDpAGeggb5hzd/pub?embedded=true"></iframe>
    </section>
